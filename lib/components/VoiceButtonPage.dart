...
class _VoiceButtonState extends State<VoiceButtonComponent> {
  ...
  void activateSpeechRecognizer() {
    ...
    _speech.activate(languages.firstWhere((l) => l.code == (widget.languageSelected == null ? 'en_US' : widget.languageSelected!)).code).then((res) {
  ...
  void start() => _speech.activate(
    languages.firstWhere((l) => l.code == (widget.languageSelected == null ? 'en_US' : widget.languageSelected!)).code).then((_) {
